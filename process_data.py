...
def convert_data():
    for i, wav_filename in tqdm(enumerate(iglob(os.path.join(DATA_AUDIO_DIR, '**/**.wav'), recursive=True))):
...
if __name__ == '__main__':
    convert_data()
    # with open('E:\\ubuntu file\\current work\\finaldataset\\nonambience\\test\\868.pkl',encoding='') as f:
    #     data = pickle.load(f)
    # print(data)
