...
class DataReader:
    def __init__(self):
        ...
        # self.train_files = self.train_files[:128]
        # self.test_files = self.test_files[:128]
...
if __name__ == '__main__':
    ...
    read_audio_from_filename('samples/18448_0_2_0.wav', target_sr=TARGET_SR)  #my dataset file
